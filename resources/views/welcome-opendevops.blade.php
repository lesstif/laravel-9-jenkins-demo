...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Atlassian Open DevOps</title>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://www.atlassian.com/solutions/devops" class="underline text-gray-900 dark:text-white">What is Open DevOps</a></div>
                            </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://www.atlassian.com/blog/devops/open-devops" class="underline text-gray-900 dark:text-white">Introducing Open DevOps</a></div>
                            </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://www.atlassian.com/solutions/devops/guides/product-guide#our-open-approach" class="underline text-gray-900 dark:text-white">Atlassian Open DevOps Product Guide</a></div>
                            </div>

                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    A brief overview of Open DevOps
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white"><a href="https://www.atlassian.com/solutions/devops/guides/getting-started#step-2" class="underline text-gray-900 dark:text-white">Getting started with Open DevOps</a></div>
                            </div>
                ...
                <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                    <div class="text-center text-sm text-gray-500 sm:text-left">
                        <div class="flex items-center">
                            ...
                            <a href="https://www.atlassian.com" class="ml-1 underline">
                                Atlassian Open DevOps Demo
                            </a>
                            ...
                            <a href="https://www.atlassian.com/blog" class="ml-1 underline">
                                Work life blog
                            </a>
                        </div>
                    </div>
